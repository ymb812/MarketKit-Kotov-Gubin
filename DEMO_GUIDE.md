...
Актуально на 6 сентября 2026. Основной показ — локальный UI; CLI остаётся резервом. План рассчитан примерно на 5–6 минут, фактический регламент и длительность нужно уточнить на репетиции.
...
- Автоматизация проверена во встроенном браузере Codex. **Отдельный Chrome не подключён и не считается проверенным.** Осталась короткая репетиция на фактическом браузере и проекторе перед выступлением.
