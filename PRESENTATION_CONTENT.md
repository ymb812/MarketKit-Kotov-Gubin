...
> **Регламент: 8 минут.** Основной текст и видеоряд должны закончиться к 7:35; последние 25 секунд — резерв на паузы и переходы.
...
Если синхронное чтение выходит за 7:35, сначала убрать из основного видеоряда подробности schema projection, callback verification и negative cases. Оставить проблему, manifest-first review, generated service, преобразования, три specs, реальные проверки и границы обещаний.
