...
Отраслевую рубрику также сохраняем отдельно: дополнительные идеи — 6 (manifest review, evidence, overrides, compatibility, validation; E4.3/E5.3/E6.2); выступление — 6 (связный текст подготовлен, видео/deck/репетиция отложены); полнота проработки — 8 (совокупность E1–E6 с явными ограничениями). Итого 20. Наличие UI само по себе не обосновывает дополнительные баллы.
...
Матрица содержит 16 экспертных карточек, 28 технических соответствий, отраслевые критерии отдельно. Этапы 2–4 завершены: вопросы Q1–Q8 имеют итог в REVIEW_REPORT, [JURY_GUIDE.md](JURY_GUIDE.md) и [MODULE_MAP.md](MODULE_MAP.md) дают внешний маршрут проверки, [PRESENTATION_CONTENT.md](PRESENTATION_CONTENT.md) содержит связный текст. Очередь выше сохраняет исходные review-вопросы для трассировки. Видео, deck и репетиция остаются отдельной работой. Основываться на итоговых результатах и ограничениях, не на предположении о максимальных баллах.
