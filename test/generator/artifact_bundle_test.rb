...
class ArtifactBundleTest < Minitest::Test
  def test_renders_required_canonical_artifacts
    ...
    assert_equal %w[INTEGRATION.md fixtures.json integration_manifest.yml novapay_service.rb], artifacts.keys.sort
    ...
    assert_equal "in_progress", fixtures.dig("fixtures", "create_payout", "success_response", "expected", "normalized_status", "value")
